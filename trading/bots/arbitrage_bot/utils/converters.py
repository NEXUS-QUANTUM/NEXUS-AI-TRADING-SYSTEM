"""
NEXUS AI TRADING SYSTEM - Arbitrage Bot Converters Utilities
Copyright © 2026 NEXUS QUANTUM LTD - All Rights Reserved
====================================================================
@version 2.0.0
@author NEXUS QUANTUM TEAM
@description Utilitaires de conversion pour le bot d'arbitrage
"""
...
class DateTimeConverter:
    ...
    def to_datetime(value: Any, default: Optional[datetime] = None) -> Optional[datetime]:
        ...
        if isinstance(value, (int, float)):
            try:
                ...
                try:
                    return datetime.fromtimestamp(value / 1000)  # ms
                except:
                    pass
    ...
    def format_datetime(
        ...
        Args:
            value: Valeur à formater
            format_str: Format de sortie ("iso", "date", "time", ou format strftime)
            default: Valeur par défaut
